...
class SalarieRepository extends Model{
	...
	public function addClient($test)
	{
		if($this->db != null)
		{
			...
			return $test->getIdSalarie();
		}
	}
	public function addCompte($test)
	{
		if($this->db != null)
		{
			$this->db->persist($test);
			...
			return $test->getIdcompteCourant();
		}
	}
